  ...
  return (
    <NavigationContainer theme={navTheme}>
      ...
      >
        ...
        <Stack.Screen name="AddExercise" component={AddExerciseScreen} options={{ title: t('exercise_title'), presentation: 'modal', animation: 'slide_from_bottom', headerTintColor: colors.burned }} />
